...
import {  faHistory, faPlus, faSun, faMoon, faSignInAlt, faSignOutAlt, faListCheck, faTimes, faRocket, faUser } from '@fortawesome/free-solid-svg-icons';
...
const Header = ({ darkMode, setDarkMode, setShowChatHistory, startNewChat, setMemoryChat }) => {
  ...
  // Placeholder for user details; assume SearchContext provides user info
  const user = isAuthenticated ? { name: userLoginData.data.username, email: userLoginData.data.email } : null; // Replace with actual user data from SearchContext
